...
All data used in this AMR analysis are public (OpenPrescribing, UKHSA, DHSC). However, I apply the same principles:

- Data accessed via official API or CSV export
- Cached locally as RDS files, not redistributed
- Code is version‑controlled and reproducible
- No patient‑identifiable information is used

## Live Environment Practice

In a live UKHSA or NHS setting, I would also:
- Follow organisational SOPs for data transfer and storage
- Use approved secure environments (e.g., NHS Secure Data Environment)
